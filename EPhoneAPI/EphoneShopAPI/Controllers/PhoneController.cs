...
namespace EPhoneAPI.Controllers
{
    ...
    public class PhoneController : ControllerBase
    {
        ...
        [HttpGet("{modelNumber}", Name = "GetPhoneByModel")]
        ...
        [HttpGet("{brand}", Name = "GetPhonesByBrand")]
        ...
        [HttpGet("{color}", Name = "GetPhonesByColor")]
        ...
        [HttpGet("{features}", Name = "GetPhonesByFeatures")]
        ...
        [HttpGet("{speed}", Name = "GetPhonesBySpeed")]
        ...
        [HttpDelete("{ModelNumber}", Name = "DeletePhone")]
